CLASS zcl_renting_load_data_0086 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_0086 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

data: lt_brands tyPE taBLE of zrent_brands0086,
      lt_cars type table of zrent_cars_0086,
      lt_customers type table of zrent_cust_0086.
...
lt_brands = VALUE #(
 ...
 DELETE FROM zrent_brands0086.
 INSERT zrent_brands0086 FROM TABLE @lt_brands.
 SELECT * FROM zrent_brands0086 INTO TABLE @lt_brands.
 out->write( sy-dbcnt ).
 out->write( 'zrent_brands0086 data inserted successfully!' ).

** CARS**
 lt_cars = VALUE #(
 ( matricula = '1246GSA'  marca = 'BMW' modelo = 'SERIE 4'  color = 'BLANCO' motor = '2.5'  potencia = '210'  und_potencia = 'CV'  combustible = 'GASOLINA'
 consumo = '7.00'  fecha_fabr = '20200418'  puertas = '5' precio = '210' moneda = 'USD' alquilado = 'X' alq_desde = '20211201' alq_hasta = '20211231' )
...
fecha_fabr = '20200812' puertas = '3' precio = '150' moneda = 'USD' alquilado = 'X' alq_desde = '20211106' alq_hasta = '20211206' )
 ...
 DELETE FROM zrent_cars_0086.
 INSERT zrent_cars_0086 FROM TABLE @lt_cars.
 SELECT * FROM zrent_cars_0086 INTO TABLE @lt_cars.
 out->write( sy-dbcnt ).
 out->write( 'zrent_cars0086 data inserted successfully!' ).
...
DELETE FROM zrent_cust_0086.
 INSERT zrent_cust_0086 FROM TABLE @lt_customers.
 SELECT * FROM zrent_cust_0086 INTO TABLE
@lt_customers.
 out->write( sy-dbcnt ).
